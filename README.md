...
<img src="https://render.githubusercontent.com/render/math?math=g(z) = \frac{1}{1+e^z}">
where <img src="https://render.githubusercontent.com/render/math?math=z = \theta^Tx">
